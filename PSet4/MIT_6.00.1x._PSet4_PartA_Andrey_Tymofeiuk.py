...
"""
MIT 6.00.1x course on edX.org: PSet4 PartA
...
def getWordScore(word, n):
    ...
    wordScore = 0
    for letter in word:
        wordScore += SCRABBLE_LETTER_VALUES.get(letter)
